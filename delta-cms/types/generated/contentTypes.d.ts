...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    openingHours: Schema.Attribute.JSON & Schema.Attribute.Required;
...
export interface ApiExpertiseExpertise extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Services et domaines d'expertise";
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['general', 'services', 'rendez-vous', 'paiement', 'assurance']
    > &
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  info: {
    description: "Section d'accueil principale avec vid\u00E9o et texte";
  ...
  attributes: {
    ...
    secondaryButtonText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'D\u00E9couvrir nos services'>;
    subtitle: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Solutions orthop\u00E9diques personnalis\u00E9es pour am\u00E9liorer votre qualit\u00E9 de vie'>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Delta Orthop\u00E9die - Votre partenaire sant\u00E9'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['assurance', 'fournisseur', 'clinique', 'laboratoire']
    > &
      Schema.Attribute.DefaultTo<'fournisseur'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTeamEnvironmentTeamEnvironment
  extends Struct.CollectionTypeSchema {
  collectionName: 'team_environments';
  info: {
    description: "Galerie d'images de l'\u00E9quipe et de l'environnement";
    displayName: 'Team Environment';
    pluralName: 'team-environments';
    singularName: 'team-environment';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['accueil', 'equipe', 'atelier', 'consultation', 'fabrication']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::team-environment.team-environment'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::team-environment.team-environment': ApiTeamEnvironmentTeamEnvironment;
